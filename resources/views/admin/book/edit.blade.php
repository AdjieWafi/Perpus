    ...
    <div class="card">
        ...
        <form action="{{route('admin.book.update', $book)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group  @error('description') text-danger has-danger @enderror">
                    ...
                    <textarea name="description" id="" rows="3" class="form-control" placeholder="Deskripsi Buku">{{$book->description ?? old('description')}}</textarea>
                ...
                <div class="form-group  @error('publisher') text-danger has-danger @enderror">
                    ...
                    <input type="text" name="publisher" class="form-control" placeholder="Masukan Nama Penerbit" value="{{$book->publisher ?? old('publisher')}}">
                ...
                <div class="form-group  @error('year') text-danger has-danger @enderror">
                    ...
                    <input type="text" name="year" class="form-control" placeholder="Masukan Tahun Terbit" value="{{$book->year ?? old('year')}}">
                ...
                <div class="form-group  @error('isbn') text-danger has-danger @enderror">
                    ...
                    <input type="text" name="isbn" class="form-control" placeholder="Masukan ISBN" value="{{$book->isbn ?? old('isbn')}}">
